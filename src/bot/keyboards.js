  ...
  return {
    reply_markup: {
      inline_keyboard: [
        ...
        [{ text: '👥 قهرمانان', callback_data: cb('myheroes', userId) }, { text: '🗺️ جهان', callback_data: cb('world', userId) }],
        [{ text: '🏰 قلمرو', callback_data: cb('realm', userId) }, { text: '💰 منابع', callback_data: cb('resources', userId) }],
        [{ text: '🤝 اتحاد', callback_data: cb('alliance', userId) }, { text: '📜 مأموریت', callback_data: cb('quest', userId) }],
        [{ text: '🎁 کد هدیه', callback_data: cb('gift', userId) }, { text: '🏆 رتبه‌بندی', callback_data: cb('ranking', userId) }],
